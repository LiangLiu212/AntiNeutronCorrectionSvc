...
#cmt_local_tagfile = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile = $(bin)$(AntiNeutronCorrectionSvc_tag).make
...
cmt_local_setup_AntiNeutronCorrectionSvc = $(bin)setup_AntiNeutronCorrectionSvc$$$$.make
...
AntiNeutronCorrectionSvc_extratags = -tag_add=target_AntiNeutronCorrectionSvc

#$(cmt_local_tagfile_AntiNeutronCorrectionSvc) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_AntiNeutronCorrectionSvc) ::
else
$(cmt_local_tagfile_AntiNeutronCorrectionSvc) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_AntiNeutronCorrectionSvc); then /bin/rm -f $(cmt_local_tagfile_AntiNeutronCorrectionSvc); fi ; \
	  $(cmtexe) -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) build tag_makefile >>$(cmt_local_tagfile_AntiNeutronCorrectionSvc)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_AntiNeutronCorrectionSvc)"; \
	  test ! -f $(cmt_local_setup_AntiNeutronCorrectionSvc) || \rm -f $(cmt_local_setup_AntiNeutronCorrectionSvc); \
	  trap '\rm -f $(cmt_local_setup_AntiNeutronCorrectionSvc)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) show setup >$(cmt_local_setup_AntiNeutronCorrectionSvc) && \
	  if [ -f $(cmt_final_setup_AntiNeutronCorrectionSvc) ] && \
	    \cmp -s $(cmt_final_setup_AntiNeutronCorrectionSvc) $(cmt_local_setup_AntiNeutronCorrectionSvc); then \
	    \rm $(cmt_local_setup_AntiNeutronCorrectionSvc); else \
	    \mv -f $(cmt_local_setup_AntiNeutronCorrectionSvc) $(cmt_final_setup_AntiNeutronCorrectionSvc); fi
...
not_AntiNeutronCorrectionSvc_dependencies = { n=0; for p in $?; do m=0; for d in $(AntiNeutronCorrectionSvc_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
AntiNeutronCorrectionSvcdirs :
	@if test ! -d $(bin)AntiNeutronCorrectionSvc; then $(mkdir) -p $(bin)AntiNeutronCorrectionSvc; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)AntiNeutronCorrectionSvc
else
AntiNeutronCorrectionSvcdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)AntiNeutronCorrectionSvc
#
#$(cmt_local_AntiNeutronCorrectionSvc_makefile) :: $(AntiNeutronCorrectionSvc_dependencies) $(cmt_local_tagfile_AntiNeutronCorrectionSvc) build_library_links dirs AntiNeutronCorrectionSvcdirs
#else
#$(cmt_local_AntiNeutronCorrectionSvc_makefile) :: $(AntiNeutronCorrectionSvc_dependencies) $(cmt_local_tagfile_AntiNeutronCorrectionSvc) build_library_links dirs
#endif
#else
#$(cmt_local_AntiNeutronCorrectionSvc_makefile) :: $(cmt_local_tagfile_AntiNeutronCorrectionSvc)
#endif

ifdef cmt_AntiNeutronCorrectionSvc_has_target_tag

ifndef QUICK
$(cmt_local_AntiNeutronCorrectionSvc_makefile) : $(AntiNeutronCorrectionSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building AntiNeutronCorrectionSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) build constituent_config -out=$(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc
else
$(cmt_local_AntiNeutronCorrectionSvc_makefile) : $(AntiNeutronCorrectionSvc_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_AntiNeutronCorrectionSvc) ] || \
	  [ ! -f $(cmt_final_setup_AntiNeutronCorrectionSvc) ] || \
	  $(not_AntiNeutronCorrectionSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building AntiNeutronCorrectionSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) build constituent_config -out=$(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc; \
	  fi
endif
...
$(cmt_local_AntiNeutronCorrectionSvc_makefile) : $(AntiNeutronCorrectionSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building AntiNeutronCorrectionSvc.make"; \
	  $(cmtexe) -f=$(bin)AntiNeutronCorrectionSvc.in -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc
else
$(cmt_local_AntiNeutronCorrectionSvc_makefile) : $(AntiNeutronCorrectionSvc_dependencies) $(cmt_build_library_linksstamp) $(bin)AntiNeutronCorrectionSvc.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_AntiNeutronCorrectionSvc) ] || \
	  [ ! -f $(cmt_final_setup_AntiNeutronCorrectionSvc) ] || \
	  $(not_AntiNeutronCorrectionSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(AntiNeutronCorrectionSvc_extratags) build constituent_makefile -out=$(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc

AntiNeutronCorrectionSvc :: $(AntiNeutronCorrectionSvc_dependencies) $(cmt_local_AntiNeutronCorrectionSvc_makefile) dirs AntiNeutronCorrectionSvcdirs
	$(echo) "(constituents.make) Starting AntiNeutronCorrectionSvc"
	@if test -f $(cmt_local_AntiNeutronCorrectionSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc; \
	  fi
#	@$(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvc
	$(echo) "(constituents.make) AntiNeutronCorrectionSvc done"

clean :: AntiNeutronCorrectionSvcclean

AntiNeutronCorrectionSvcclean :: $(AntiNeutronCorrectionSvcclean_dependencies) ##$(cmt_local_AntiNeutronCorrectionSvc_makefile)
	$(echo) "(constituents.make) Starting AntiNeutronCorrectionSvcclean"
	@-if test -f $(cmt_local_AntiNeutronCorrectionSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvcclean; \
	fi
	$(echo) "(constituents.make) AntiNeutronCorrectionSvcclean done"
#	@-$(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) AntiNeutronCorrectionSvcclean

##	  /bin/rm -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) $(bin)AntiNeutronCorrectionSvc_dependencies.make

install :: AntiNeutronCorrectionSvcinstall

AntiNeutronCorrectionSvcinstall :: $(AntiNeutronCorrectionSvc_dependencies) $(cmt_local_AntiNeutronCorrectionSvc_makefile)
	$(echo) "(constituents.make) Starting install AntiNeutronCorrectionSvc"
	@-$(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) install
	$(echo) "(constituents.make) install AntiNeutronCorrectionSvc done"

uninstall : AntiNeutronCorrectionSvcuninstall

$(foreach d,$(AntiNeutronCorrectionSvc_dependencies),$(eval $(d)uninstall_dependencies += AntiNeutronCorrectionSvcuninstall))

AntiNeutronCorrectionSvcuninstall : $(AntiNeutronCorrectionSvcuninstall_dependencies) ##$(cmt_local_AntiNeutronCorrectionSvc_makefile)
	$(echo) "(constituents.make) Starting uninstall AntiNeutronCorrectionSvc"
	@if test -f $(cmt_local_AntiNeutronCorrectionSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_AntiNeutronCorrectionSvc_makefile) uninstall
	$(echo) "(constituents.make) uninstall AntiNeutronCorrectionSvc done"

remove_library_links :: AntiNeutronCorrectionSvcuninstall
...
#cmt_local_tagfile_install_includes = $(AntiNeutronCorrectionSvc_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(AntiNeutronCorrectionSvc_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)AntiNeutronCorrectionSvc_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_install_includes = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(AntiNeutronCorrectionSvc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(AntiNeutronCorrectionSvc_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)AntiNeutronCorrectionSvc_makesetup.make
...
#cmt_local_tagfile_make = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_make = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(AntiNeutronCorrectionSvc_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(AntiNeutronCorrectionSvc_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)AntiNeutronCorrectionSvc_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(AntiNeutronCorrectionSvc_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(AntiNeutronCorrectionSvc_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)AntiNeutronCorrectionSvc_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(AntiNeutronCorrectionSvc_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(AntiNeutronCorrectionSvc_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)AntiNeutronCorrectionSvc_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(AntiNeutronCorrectionSvc_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(AntiNeutronCorrectionSvc_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)AntiNeutronCorrectionSvc_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(AntiNeutronCorrectionSvc_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(AntiNeutronCorrectionSvc_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)AntiNeutronCorrectionSvc_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_TestProject = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(AntiNeutronCorrectionSvc_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(AntiNeutronCorrectionSvc_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)AntiNeutronCorrectionSvc_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(AntiNeutronCorrectionSvc_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(AntiNeutronCorrectionSvc_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)AntiNeutronCorrectionSvc_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(AntiNeutronCorrectionSvc_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(AntiNeutronCorrectionSvc_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)AntiNeutronCorrectionSvcsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
